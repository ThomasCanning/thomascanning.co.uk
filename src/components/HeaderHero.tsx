export default function HeaderHero() {
  return (
    <header className="relative text-[color:var(--color-on-brand)] bg-[linear-gradient(180deg,var(--color-brand-dark)_0%,var(--color-brand)_100%)] py-[6vw]">
      <div className="max-w-[1800px] mx-auto px-[10vw]">
        <div className="flex flex-col md:flex-row items-center md:items-stretch justify-between text-center md:text-left gap-6">
          <div className="flex flex-col items-center md:items-center justify-center mx-auto">
            <h1 className="font-extrabold drop-shadow-[5px_5px_10px_var(--color-shadow-strong)] text-[max(5vw,4rem)]">
              Thomas Canning
            </h1>
            <p className="text-[color:var(--color-on-brand)] text-[clamp(1rem,2.5vw,1.5rem)]">
              Computer Science BSc Student and Software Engineer
            </p>
            <div className="mt-4 flex items-center justify-center text-[color:var(--color-on-brand)]">
              <a
              ...
              <span className="mx-2 text-[color:var(--color-on-brand)]">|</span>
              <a
          ...
          <div className="flex justify-center items-center rounded-full p-2 overflow-hidden w-[60%] md:w-[min(40%,700px)] md:h-[min(40%,800px)] md:rounded-full mx-[6vw]">
            <img
              className="w-full h-full object-cover rounded-full shadow-[0_0_15px_var(--color-shadow-medium)]"
