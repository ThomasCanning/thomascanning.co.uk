...
export default function WorkExperienceSection() {
  return (
    <section id="work-experience" className="relative scroll-mt-24 bg-[#B2CADF] flex flex-col items-start min-h-[400px] pt-[12rem] px-[10vw] pb-12">
      <Wave fill="#7DA0BF" />
      <div className="w-full max-w-[1800px] mx-auto">
        ...
        <h3 id="confluent-internship" className="text-[1.6rem] font-normal text-[#2b2b2b]"><strong>Software Engineering Internship</strong> - Confluent (05/2024 - 05/2025)</h3>
        <p className="text-[1.4rem] text-[#2b2b2b]">
        ...
        <h3 className="mt-4 text-[1.6rem] font-normal text-[#2b2b2b]"><strong>Peer Assisted Learning Leader</strong> - University of Bath (09/2023 - 05/2024)</h3>
        <p className="mb-6 text-[1.4rem] text-[#2b2b2b]">
        ...
        <h3 className="text-[1.6rem] font-normal text-[#2b2b2b]"><strong>Outdoor Activities Instructor</strong> - Hautbois Activity Centre (04/2022 - 06/2024)</h3>
        <p className="text-[1.4rem] text-[#2b2b2b]">
